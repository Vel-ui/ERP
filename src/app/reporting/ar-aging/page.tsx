...
const MOCK_DATA: ARRow[] = [
  { id: "1", customer: "Acme Corporation", current: 48500, days1to30: 22300, days31to60: 8400, days61to90: 3200, days90plus: 1500 },
  { id: "2", customer: "TechVentures Inc.", current: 62000, days1to30: 15800, days31to60: 12500, days61to90: 0, days90plus: 0 },
  { id: "3", customer: "GlobalSoft LLC", current: 35200, days1to30: 28400, days31to60: 14200, days61to90: 6800, days90plus: 4200 },
  { id: "4", customer: "CloudScale Systems", current: 78400, days1to30: 31200, days31to60: 0, days61to90: 0, days90plus: 0 },
  { id: "5", customer: "DataStream Analytics", current: 24600, days1to30: 18900, days31to60: 9700, days61to90: 5100, days90plus: 2800 },
  { id: "6", customer: "NovaPay Financial", current: 55800, days1to30: 12400, days31to60: 6300, days61to90: 0, days90plus: 0 },
  { id: "7", customer: "Pinnacle Health Tech", current: 41200, days1to30: 19500, days31to60: 11800, days61to90: 7400, days90plus: 5600 },
  { id: "8", customer: "Summit Enterprises", current: 29800, days1to30: 8600, days31to60: 4200, days61to90: 2100, days90plus: 900 },
  { id: "9", customer: "Velocity Motors", current: 67300, days1to30: 24100, days31to60: 0, days61to90: 0, days90plus: 0 },
  { id: "10", customer: "Horizon Media Group", current: 18500, days1to30: 14200, days31to60: 8900, days61to90: 4300, days90plus: 3100 },
];

function getTotal(row: ARRow) {
...
type SortKey = "customer" | "current" | "days1to30" | "days31to60" | "days61to90" | "days90plus" | "total";
    ...
    <div className="min-h-screen">
      <div className="border-b border-border px-8 py-4" style={{ background: 'var(--mx-bg-card)' }}>
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="mx-h2">AR Aging</h1>
          <span className="rounded-full bg-amber-500/15 px-2.5 py-0.5 text-xs font-medium text-amber-400">As of Dec 31, 2025</span>
        </div>
      ...
      <div className="px-8 py-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="mx-card mx-card-white">
            <p className="text-xs mx-text-secondary">Total Receivables</p>
              ...
              <tr>
                {columns.map((col) => (
                  <th
                    ...
                    className={`cursor-pointer transition-colors ${col.key === "customer" ? "text-left" : "text-right"} ${col.color || ""}`}
                  >
                    {col.label}
